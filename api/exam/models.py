...
class CustomUser(AbstractUser):
    ...
    username = models.CharField(
        max_length=255, blank=True, null=True, default="user")
...
class Visitor(models.Model):
    ...
    user = models.OneToOneField(
        CustomUser, on_delete=models.CASCADE, primary_key=True, related_name="visitor")
...
class Member(models.Model):
    ...
    bits_id = models.CharField(
        max_length=50, blank=False, null=False, verbose_name="BITS ID", default="20XXXXXSXXXX")
    bits_email = models.EmailField(max_length=100, verbose_name="BITS Email",
                                   blank=False, null=False, default="f20xxxxxx@*.bits-pilani.ac.in")
    department = models.ForeignKey(
        'main.Department', on_delete=models.CASCADE, related_name="department", blank=True, null=True)
    github = models.CharField(
        max_length=20, blank=False, null=False, default="my_github")
...
class Candidate (models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, primary_key=True, related_name="candidate")

    gender = models.CharField(max_length=1, choices=gender_choices)
    bits_id = models.CharField(
        verbose_name="BITS ID", max_length=13, unique=True, blank=False)
    bits_email = models.EmailField(max_length=100, verbose_name="BITS Email",
                                   blank=False, null=False, default="f20xxxxxx@*.bits-pilani.ac.in")
    github = models.CharField(
        max_length=20, blank=False, null=False, default="my_github")

    pr1 = models.CharField(verbose_name="First Priority",
                           max_length=2, choices=departments, default=None)
    pr2 = models.CharField(verbose_name="Second Priority",
                           max_length=2, choices=departments, default=None)
    pr3 = models.CharField(verbose_name="Third Priority",
                           max_length=2, choices=departments, default=None)
    pr4 = models.CharField(verbose_name="Fourth Priority",
                           max_length=2, choices=departments, default=None)
    pr5 = models.CharField(verbose_name="Fifth Priority",
                           max_length=2, choices=departments, default=None)
