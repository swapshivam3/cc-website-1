...
class Navbar extends Component {
  ...
  state = { clicked: false, hamOpen: false, icon: false, size: 0 };
  handleClick = () => {
        ...
        {this.state.hamOpen ? (
          ...
          <section >  
            ...
            >
              ...
              <Grid container  style={{padding:"4%",paddingTop:"0" , paddingBottom: "0"}}  className="nav-menu-1">
              ...
              <p className = "NavText">Bits Pilani Pilani Campus</p>
                  ...
                  return (
                    <Grid xs={12} key={index} style={{ paddingBottom: "2rem" }} align="center" >
                      <Link className={item.cName} to={item.url} onClick = {this.handleLinkChange}>
                        {item.title}
                      </Link>
                    </Grid>
                  );
              ...
              <Grid container  style={{padding:"4%",paddingTop:"0" , paddingBottom: "0"}} >
                  ...
                  <Grid item xs={12} style={{paddingLeft:"10%",paddingRight:"10%"}}>
                    <div>
                      ...
                      {MenuSocial.map((item, index) => {
                  return (
                    <Grid xs={3} key={index} style={{ paddingBottom: "2rem" }} align="center">
                      <Link className={item.cName} to={item.url} onClick = {this.handleLinkChange}>
                        {item.title}
                      </Link>
                    </Grid>
